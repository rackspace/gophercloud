...
// Error401er is the interface resource implement to override the error message
// from a 401 error.
type Error401er interface {
	Error401(*UnexpectedResponseCodeError) error
}

// Error404er is the interface resource implement to override the error message
// from a 404 error.
type Error404er interface {
	Error404(*UnexpectedResponseCodeError) error
}

// Error405er is the interface resource implement to override the error message
// from a 405 error.

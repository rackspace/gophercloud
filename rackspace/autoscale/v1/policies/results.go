...
type Policy struct {
	...
	// Cooldown period, in seconds, for webhook policies.
	Cooldown int `mapstructure:"cooldown" json:"cooldown"`

	// Number of servers added or, if negative, removed.
	Change int `mapstructure:"change" json:"change"`

	// Percent change to make in the number of servers.
	ChangePercent float64 `mapstructure:"changePercent" json:"changePercent"`
